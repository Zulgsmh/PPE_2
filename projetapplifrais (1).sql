...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 22 jan. 2019 à 09:32
...
--
-- Base de données :  `projetapplifrais`
--
...
('1', 'Comptable', 'Comptable', 'Comptable', '123', 'ccccc', 91000, 'evry', '2018-10-24');
...
CREATE TABLE IF NOT EXISTS `document` (
  `idJustificatif` int(100) NOT NULL AUTO_INCREMENT,
  `idFraisForfait` varchar(11) NOT NULL,
  `path` varchar(250) NOT NULL,
  `idVisiteur` varchar(11) NOT NULL,
  `nomJustificatif` varchar(255) NOT NULL,
  `MontantJustificatif` float NOT NULL,
...
INSERT INTO `document` (`idJustificatif`, `idFraisForfait`, `path`, `idVisiteur`, `nomJustificatif`, `MontantJustificatif`) VALUES
(1, 'NUI', 'bonjour', 'a131', 'Nuit Paris', 90);
...
('a131', '10', 1, '100.00', '2018-11-27', 'VA'),
('a55', '12', 2, '150.00', '2018-12-12', 'CR');
...
INSERT INTO `lignefraisforfait` (`id`, `idVisiteur`, `mois`, `idFraisForfait`, `quantite`, `montant`) VALUES
(1, 'a131', '10', 'KM', 1, 0),
(2, 'a131', '10', 'NUI', 1, 50);
...
ALTER TABLE `document`
  ADD CONSTRAINT `document_ibfk_1` FOREIGN KEY (`idFraisForfait`) REFERENCES `fraisforfait` (`id`),
  ADD CONSTRAINT `document_ibfk_2` FOREIGN KEY (`idVisiteur`) REFERENCES `visiteur` (`id`);
